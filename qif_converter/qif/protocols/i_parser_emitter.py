# qif_converter/qif/protocols/i_parser_emitter.py
...
from typing import Protocol, Iterable, TypeVar, runtime_checkable, overload
from ..protocols import QuickenFileType

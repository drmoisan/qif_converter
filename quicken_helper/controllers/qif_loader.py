...
class _Split(
    ISplit
):  # conforms structurally; inheriting is optional but convenient for type checkers
    amount: Decimal
    category: str
    memo: str = ""
...
class _Txn(ITransaction):
    ...
    type: Optional[IHeader] = (
        None  # keep the attribute name 'type' to match the protocol
    )
